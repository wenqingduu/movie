...
> 2026-08-25 最终更新：当前带 soft-context 调色与 BiSeNet 保守语义 mask 的 IP-Adapter 大角度结果位于 `experiment_output/ip_adapter_high_yaw_harmonized_soft_context_v4_04/`；旧结果已移到回收站。最终对比见 `HARMONIZED_3D_INJECTION_COMPARISON_STATUS.md`。
